...
export default function Button({ href, children, className = "", onClick, ...rest }: ButtonProps) {
  const baseStyles =
    "inline-flex items-center justify-center rounded-[8px] bg-gradient-primary text-dark-card font-inter font-[600] transition-all duration-300 hover:brightness-110 active:scale-[0.98]";
